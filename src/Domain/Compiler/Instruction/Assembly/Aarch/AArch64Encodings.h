...
enum Aarch64Instruction : uint32_t
{
    ...
    Mask25 = MASK(0, 25),
    Mask26 = MASK(0, 26),
    AdrpMask = static_cast<uint32_t>(0b10011111) << 24,
    ...
    AdrImmediate32 = static_cast<uint32_t>(0b00010000) << 24,
    AdrpImmediate64 = static_cast<uint32_t>(0b10010000) << 24,
    ...
    Br = static_cast<uint32_t>(0b1101011000011111000000000000000) << 0,
