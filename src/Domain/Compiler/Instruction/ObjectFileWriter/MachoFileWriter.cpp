...
namespace elet::domain::compiler::instruction::output::macho
{
    ...
    MachoFileWriter::writeDysymTabCommand()
    {
        DysymTabCommand command =
        {
            ...
            .localSymbolIndex = 0,
            .localSymbolEntries = 0,
            .definedExternalSymbolIndex = 0,
            .definedExternalSymbolEntries = 0,
            .undefinedSymbolIndex = 0,
            .undefinedSymbolNumber = 0,
            .tableOfContentOffset = 0,
            .tableOfContentEntries = 0,
            .moduleTableOffset = 0,
            .moduleTableEntries = 0,
            .externalReferenceTableOffset = 0,
            .externalReferenceTableEntries = 0,
            .indirectSymbolTableOffset = 0,
            .indirectSymbolTableEntries = 0,
            .externalRelocationTableOffset = 0,
            .externalRelocationTableEntries = 0,
            .localRelocationTableOffset = 0,
            .localRelocationTableEntries = 0,
        };
        _header->numberOfCommands++;
