...
namespace elet::foundation
{
    ...
    Utf8StringView::Utf8StringView(const char* start, const char* end):
        _value(start),
        _end(end)
    {
    ...
    const char*
    Utf8StringView::Iterator::getPositionAddress() const
    {
        return value;
    }
    ...
    {
        const char* currentPosition = getPositionAddress();
        ++(*this);
